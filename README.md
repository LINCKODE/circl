...
[![GitHub release](https://img.shields.io/github/release/cloudflare/circl.svg)](https://github.com/linckode/circl/releases/)
[![CIRCL](https://github.com/linckode/circl/workflows/CIRCL/badge.svg)](https://github.com/linckode/circl/actions)
[![GoDoc](https://godoc.org/github.com/linckode/circl?status.svg)](https://pkg.go.dev/github.com/linckode/circl?tab=overview)
[![Go Report Card](https://goreportcard.com/badge/github.com/linckode/circl)](https://goreportcard.com/report/github.com/linckode/circl)
...
🚨 This library is offered as-is, and without a guarantee. Therefore, it is expected that changes in the code, repository, and API occur in the future. We recommend to take caution before using this library in a production application since part of its content is experimental. All security issues must be reported, please notify us immediately following the instructions given in our [Security Policy](https://github.com/linckode/circl/security/policy).
